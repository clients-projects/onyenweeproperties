        ...
        <>
            <div className='whoWeAre'>
                ...
                <p className='whoWeAre__text'>
                    ...
                    are a team of professionals with young vibrant and
                    experienced sales men and women, property managers, valuers,
                    architects, Surveyors, financial analysts and civil
                    engineers. With over 30years experience and dominant in the
                    real estate industry in the south Eastern region of the
                    country we have our head office at Rufia Garuba Real Estate
                    off Aroma junction Awka State Capital Anambara state. Our
                    branch network extends beyond the region covering most parts
                    of the country.
                </p>
            </div>
            <div className='estateServices'>
                ...
                <div className='estateServices__item'>
                    ...
                    <hr />
                    <p>
                        We take the time to understand your rental requirements
                        and work with you to find the property that suits your
                        needs.
                    </p>
                </div>
                <div className='estateServices__item'>
                    ...
                    <hr />
                    <p>
                        Our team apply their years of experience to help you
                        achieve the best possible return for your property
                ...
                <div className='estateServices__item'>
                    ...
                    <hr />
                    <p>
                        We ensure peace of mind by securing high quality tenants
                        and the highest possible rent alongside diligent routine
                        inspections.
                    </p>
                </div>
            </div>
